 ...
 * @author  test1
 */
public class appManager extends javax.swing.JDialog implements Runnable {
    
    String command = new String();
    
    /** Creates new form projectOpen */
    public appManager(mainForm parent, boolean modal, String cmd ) {
        super(parent, modal);
        initComponents();
        myParent = parent;
        command = cmd;
    ...
    public void run() {
        ...
        try {
            if( command.equalsIgnoreCase( "stop") ) {
                messageLabel.setText( "Stopping web application, please wait ..." );
            } else if( command.equalsIgnoreCase( "start") ) {
                messageLabel.setText( "Starting web application, please wait ..." );
            } else if( command.equalsIgnoreCase( "reload") ) {
                messageLabel.setText( "Reloading web application, please wait ..." );
            } else if( command.equalsIgnoreCase( "unwar") ) {
                messageLabel.setText( "Unwarring web application, please wait ..." );
            }
                        
            myParent.remoteCommand( command );            
