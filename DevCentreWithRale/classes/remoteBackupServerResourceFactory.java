 ...
 * @author  test1
 */
public class remoteBackupServerResourceFactory extends javax.swing.JDialog implements Runnable {
    
    String command = new String();
    
    /** Creates new form projectOpen */
    public remoteBackupServerResourceFactory(mainForm parent, boolean modal ) {
        super(parent, modal);
        initComponents();
        myParent = parent;               
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Backup Server Resource Factory Configuration");
    ...
    public void run() {
        ...
        try {
            ...
            messageLabel.setText( "Backing up Server Resource Factory configuration, please wait ..." );
            
            myParent.setBackupServerXmlResult( myParent.remoteOtherCommand( "backupServerResourceFactory", "dummy" ) ); 
