 ...
 * @author  test1
 */
public class commonClasses extends javax.swing.JDialog {
    
    /** Creates new form projectOpen */
    public commonClasses(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        chooser.setDialogTitle("Select Class");
        chooser.setFont(new java.awt.Font("Default", 0, 11));

        setTitle("Common Server Classes");
        ...
        listButton.setText("List Java Classes");
        ...
        classNameTextField.setMinimumSize(new java.awt.Dimension(150, 19));
        classNameTextField.setPreferredSize(new java.awt.Dimension(350, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        jPanel6.add(classNameTextField, gridBagConstraints);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        char nextLine = '|';
        String classFile = classNameTextField.getText().trim();
        
        if( classFile.indexOf( '\\' ) != -1 ) {
            classFile = classFile.substring( classFile.lastIndexOf( '\\' )+1 );
        }
        
        if( classFile.length() > 0  ) {
            myParent.printMessage( "Deleting common Java class from server" );
            sendJarLibrary sjl = new sendJarLibrary( myParent, this, false, "deletecommonclass", "dummy", classFile );
            sjl.show();
        }
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if( classFile.indexOf( '\\' ) != -1 ) {
            absoluteFileName = classFile.substring( classFile.lastIndexOf( '\\' )+1 );
        }
        
        if( classFile.length() > 0 && new File( classFile ).exists() && new File( classFile ).isFile()  ) {
            
            myParent.printMessage( "Checking server for existing file" );
            String returnMessage = myParent.remoteOtherCommand( "listcommonclasses", "dummy" );
            
            if( returnMessage.indexOf( absoluteFileName ) == -1  ) {
                myParent.printMessage( "Sending Java class  to server" );
                sendJarLibrary sjl = new sendJarLibrary( myParent, this, false, "getcommonclassespath", "dummy", classFile );
                sjl.show();
            } else {
    ...
    private void listButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listButtonActionPerformed
        ...
        myParent.printMessage( "Listing Java classes" );
        listJarLibraries ljl = new listJarLibraries( myParent, this, false, "listcommonclasses", "dummy" );
        ljl.show();
        ...
        if (retval == JFileChooser.APPROVE_OPTION) {
            ...
            if( theFile != null ) {
                if( !theFile.isDirectory() ) {
                    ...
                    classNameTextField.setText( theFile.getAbsolutePath() );
                }
            }
