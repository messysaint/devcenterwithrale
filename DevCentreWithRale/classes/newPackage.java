 ...
 * @author  test1
 */
public class newPackage extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newPackage(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel6.add(newPackageTextField);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if( newPackage.length() == 0 ) {
            ...
            newPackage = getTreeCurrentPath() + '\\' + newPackage;
