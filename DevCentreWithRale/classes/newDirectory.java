 ...
 * @author  test1
 */
public class newDirectory extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newDirectory(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel11.setText("Directory Name:");
        ...
        jPanel6.add(newDirectoryTextField);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if( newDirectory.length() == 0 ) {
            ...
            newDirectory = getTreeCurrentPath() + '\\' + newDirectory;
    ...
    private DirectoryTree treePanel = new DirectoryTree();
