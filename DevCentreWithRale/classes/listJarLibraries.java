 ...
 * @author  test1
 */
public class listJarLibraries extends javax.swing.JDialog implements Runnable {
    
    String command = new String();
    String appName = new String();
    
    /** Creates new form projectOpen */
    public listJarLibraries(mainForm parent, JDialog toDialog, boolean modal, String cmd, String warFile) {
        super(parent, modal);
        initComponents();
        myParent = parent;
        dialog = toDialog;
    ...
    public void run() {
        ...
        try {
            if( command.equalsIgnoreCase( "listcommonlib") ) {
                messageLabel.setText( "Listing Java libraries, please wait ..." );
                String httpMessage = myParent.remoteOtherCommand( command, appName );
                httpMessage = httpMessage.replace( nextLine, '\n' );
                jarLibraries.messageEditorPane.setText( httpMessage );
            } else if( command.equalsIgnoreCase( "listcommonclasses") ) {
                messageLabel.setText( "Listing Java classes, please wait ..." );
                String httpMessage = myParent.remoteOtherCommand( command, appName );
                httpMessage = httpMessage.replace( nextLine, '\n' );
                commonClasses.messageEditorPane.setText( httpMessage );
            }
