...
public class projectConnectionSettings extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel6.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(), "RALE Connection Setting"));
        ...
        loaderUserName.setEditable(false);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(jLabel112211, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(sshRemoteDirectory, gridBagConstraints);
        ...
        jPanel6.add(getWebAppDirButton, gridBagConstraints);
        ...
        setBounds((screenSize.width-516)/2, (screenSize.height-474)/2, 516, 474);
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        key = getKey();
        configline[9] = "loaderPort = " + key+psec.encryptToBase64( loaderPort.getText().trim(), key );
        key = getKey();
        configline[10] = "loaderUserName = " + key+psec.encryptToBase64( loaderUserName.getText().trim(), key );
        key = getKey();
        configline[11] = "loaderPassword = " + key+psec.encryptToBase64( loaderPassword.getText().trim(), key );
