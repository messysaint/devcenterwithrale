 ...
 * @author  test1
 */
public class archiveSendFile extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public archiveSendFile(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    public archiveSendFile(mainForm parent, boolean modal, String file ) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please wait while sending file to server...");
    ...
    public void run() {
        ...
        try {
            if( selectedFile.length() == 0) {
                ...
                myParent.sendFile( selectedFile );
            }
