 ...
 * @author  test1
 */
public class sourceOtherEditorIF extends javax.swing.JInternalFrame {
    
    
    /** Creates new form mvcController */
    public sourceOtherEditorIF(mainForm mainSource, String selectedFile) {
        ...
        setTitle( getTitle() + " " + fileSource.substring( fileSource.indexOf( '.' ) ).toUpperCase() + " [ " + fileSource.substring( main.getBuildDirectory().length() ) + " ]" );
