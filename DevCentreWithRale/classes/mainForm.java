...
public class mainForm extends javax.swing.JFrame {
    ...
    public mainForm() {
        ...
        // store browser home
        fileName = getArchiverBaseDir() + browserHome;
        if( new File( fileName).exists() ) {
            storeBrowserHome();
        }
        ...
        if( !lic.isLicenseValid() ) {
            ...
            printMessage( "Demo License has expired."  );
            printMessage( "Go to \"http://www.hoversoftcorp.com\" to purchase a license."  );            
            // display license input form
            disableIDE();
            // force expire the demo license
            lic.writeDemoExpiredLicense();                                                            
            
        } else {
            // display license message in IDE message area
            printMessage( lic.getLicenseMessage()  );
        }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        appMgr = new javax.swing.JButton();
        ...
        objectTree.initTree();
        objectTree.setPreferredSize(new Dimension(77, 150));
        objectScrollPane.setViewportView( objectTree );

        libScrollPane = new javax.swing.JScrollPane();
        //libTree.initTree();
        libTree.setPreferredSize(new Dimension(77, 150));
        libScrollPane.setViewportView( libTree );

        classPathScrollPane = new javax.swing.JScrollPane();
        classPathTree.setPreferredSize(new Dimension(77, 150));
        classPathScrollPane.setViewportView( classPathTree );
        ...
        ExternalWebBrowserMenuItem = new javax.swing.JMenuItem();
        ...
        tagHandlerMenuItem = new javax.swing.JMenuItem();
        ...
        compileAllJavaMenuItem = new javax.swing.JMenuItem();
        compileAllJSPMenuItem = new javax.swing.JMenuItem();
        compileAllJWSMenuItem = new javax.swing.JMenuItem();
        ...
        activateLicenseMenuItem = new javax.swing.JMenuItem();
        ...
        projectNew.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/new.gif")));
        projectNew.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/new.gif")));
        ...
        projectOpen.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/open.gif")));
        projectOpen.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/open.gif")));
        ...
        appMgr.setFont(new java.awt.Font("Default", 0, 11));
        appMgr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/appmgr.gif")));
        appMgr.setToolTipText("Manage Applications");
        appMgr.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 1, 1, 1)));
        appMgr.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/appmgr.gif")));
        appMgr.setDisabledSelectedIcon(new javax.swing.ImageIcon("/icons/appmgr.gif"));
        appMgr.setDoubleBuffered(true);
        appMgr.setEnabled(false);
        appMgr.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                appMgrActionPerformed(evt);
            }
        });
        ...
        fileTable.setIntercellSpacing(new java.awt.Dimension(2, 2));
        fileTable.setRowSelectionAllowed(false);
        fileTable.setEnabled(false);
        jSplitPane4.setLeftComponent(fileTable);

        objectScrollPane.setBorder(new javax.swing.border.EtchedBorder());
        jSplitPane4.setRightComponent(objectScrollPane);

        propertiesTabbedPane.addTab("File", jSplitPane4);

        libScrollPane.setBorder(new javax.swing.border.EtchedBorder());
        libScrollPane.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                libScrollPaneMouseClicked(evt);
            }
        });

        propertiesTabbedPane.addTab("Web App Libraries", libScrollPane);

        classPathScrollPane.setBorder(new javax.swing.border.EtchedBorder());
        propertiesTabbedPane.addTab("Project ClassPath", classPathScrollPane);

        jSplitPane3.setRightComponent(propertiesTabbedPane);

        jSplitPane1.setLeftComponent(jSplitPane3);

        jSplitPane2.setDividerLocation(525);
        jSplitPane2.setOrientation(javax.swing.JSplitPane.VERTICAL_SPLIT);
        codeDesktopPane.setFont(new java.awt.Font("MS Sans Serif", 0, 11));
        ...
        projectOpenMenuItem.setDoubleBuffered(true);
        ...
        jSeparator16.setDoubleBuffered(true);
        projectMenu.add(jSeparator16);

        searchProjectMenuItem.setText("Search Files");
        searchProjectMenuItem.setDoubleBuffered(true);
        ...
        projectMenu.add(addJarToClassPathMenuItem);

        copyJarMenuItem.setText("Copy Jar to Application");
        copyJarMenuItem.setDoubleBuffered(true);
        ...
        projectMenu.add(copyJarMenuItem);

        jSeparator152.setDoubleBuffered(true);
        projectMenu.add(jSeparator152);

        J2SDKHomeMenuItem.setText("Java2 SDK Home");
        J2SDKHomeMenuItem.setDoubleBuffered(true);
        ...
        projectMenu.add(J2SDKHomeMenuItem);

        ExternalWebBrowserMenuItem.setText("External Web Browser");
        ExternalWebBrowserMenuItem.setDoubleBuffered(true);
        ExternalWebBrowserMenuItem.setEnabled(false);
        ExternalWebBrowserMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ExternalWebBrowserMenuItemActionPerformed(evt);
            }
        });

        projectMenu.add(ExternalWebBrowserMenuItem);

        targetJVMMenuItem.setText("Target JVM Version");
        targetJVMMenuItem.setDoubleBuffered(true);
        ...
        projectMenu.add(targetJVMMenuItem);

        jSeparator15.setDoubleBuffered(true);
        projectMenu.add(jSeparator15);

        connectionSettingMenuItem.setText("Server Connection");
        connectionSettingMenuItem.setDoubleBuffered(true);
        ...
        projectMenu.add(connectionSettingMenuItem);

        jSeparator151.setDoubleBuffered(true);
        projectMenu.add(jSeparator151);
        ...
        webAppDescriptorMenuItem.setDoubleBuffered(true);
        ...
        antBuildXml.setDoubleBuffered(true);
        ...
        dbConnectionPoolMenuItem.setDoubleBuffered(true);
        ...
        jarLibrariesMenuItem.setDoubleBuffered(true);
        ...
        commonClassMenuItem.setDoubleBuffered(true);
        ...
        resourceFactoryMenuItem.setDoubleBuffered(true);
        ...
        jMenu7.setDoubleBuffered(true);
        jMenu7.setEnabled(false);
        jMenu6.setText("New");
        jMenu6.setDoubleBuffered(true);
        jspMenuItem.setText("JavaServer Page");
        jspMenuItem.setDoubleBuffered(true);
        ...
        servletMenuItem.setDoubleBuffered(true);
        ...
        beanMenuItem.setDoubleBuffered(true);
        ...
        tagHandlerMenuItem.setText("JSP Tag Handler");
        tagHandlerMenuItem.setDoubleBuffered(true);
        tagHandlerMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tagHandlerMenuItemActionPerformed(evt);
            }
        });

        jMenu6.add(tagHandlerMenuItem);

        classMenuItem.setText("Java Class");
        classMenuItem.setDoubleBuffered(true);
        ...
        jMenu6.add(classMenuItem);

        jwsMenuItem.setText("Java Web Service");
        jwsMenuItem.setDoubleBuffered(true);
        ...
        htmlMenuItem.setDoubleBuffered(true);
        ...
        htmlTemplateProjectMenuItem.setDoubleBuffered(true);
        ...
        propertyMenuItem.setDoubleBuffered(true);
        ...
        xmlMenuItem.setDoubleBuffered(true);
        ...
        jMenu6.add(xmlMenuItem);

        textMenuItem.setText("Text File");
        textMenuItem.setDoubleBuffered(true);
        ...
        saveAllMenuItem.setDoubleBuffered(true);
        ...
        compileMenuItem.setDoubleBuffered(true);
        ...
        compileAllMenuItem.setDoubleBuffered(true);
        ...
        compileAllJavaMenuItem.setText("Compile All JAVA");
        compileAllJavaMenuItem.setDoubleBuffered(true);
        compileAllJavaMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                compileAllJavaMenuItemActionPerformed(evt);
            }
        });

        jMenu8.add(compileAllJavaMenuItem);

        compileAllJSPMenuItem.setText("Compile All JSP");
        compileAllJSPMenuItem.setDoubleBuffered(true);
        compileAllJSPMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                compileAllJSPMenuItemActionPerformed(evt);
            }
        });

        jMenu8.add(compileAllJSPMenuItem);

        compileAllJWSMenuItem.setText("Compile All JWS");
        compileAllJWSMenuItem.setDoubleBuffered(true);
        compileAllJWSMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                compileAllJWSMenuItemActionPerformed(evt);
            }
        });

        jMenu8.add(compileAllJWSMenuItem);

        compileProjectMenuItem.setText("Compile Project");
        compileProjectMenuItem.setDoubleBuffered(true);
        ...
        RefreshMenuItem.setDoubleBuffered(true);
        ...
        SendArchiveMenuItem.setDoubleBuffered(true);
        ...
        StopMenuItem.setDoubleBuffered(true);
        ...
        StartMenuItem.setDoubleBuffered(true);
        ...
        ReloadMenuItem.setDoubleBuffered(true);
        ...
        UnWARMenuItem.setDoubleBuffered(true);
        ...
        StopStartMenuItem.setDoubleBuffered(true);
        ...
        manageMenuItem.setDoubleBuffered(true);
        ...
        onlineHelpMenuItem.setFont(new java.awt.Font("Default", 0, 11));
        onlineHelpMenuItem.setText("Online Help");
        onlineHelpMenuItem.setDoubleBuffered(true);
        jMenu5.add(onlineHelpMenuItem);

        activateLicenseMenuItem.setText("License Key");
        activateLicenseMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                activateLicenseMenuItemActionPerformed(evt);
            }
        });

        jMenu5.add(activateLicenseMenuItem);
    ...
    private void activateLicenseMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activateLicenseMenuItemActionPerformed
        // TODO add your handling code here:
        activateLicense al = new activateLicense( this, false );
        al.show();
    }//GEN-LAST:event_activateLicenseMenuItemActionPerformed
    
    private void compileAllJWSMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compileAllJWSMenuItemActionPerformed
        // Add your handling code here:
        saveAllFiles sf = new saveAllFiles( this, true );
        sf.show();
        compileAllJWSFiles cajspf = new compileAllJWSFiles( this, false );
        cajspf.show();
    }//GEN-LAST:event_compileAllJWSMenuItemActionPerformed
    
    private void compileAllJavaMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compileAllJavaMenuItemActionPerformed
        // Add your handling code here:
        saveAllFiles sf = new saveAllFiles( this, true );
        sf.show();
        compileAllJAVAFiles cajspf = new compileAllJAVAFiles( this, false );
        cajspf.show();
    }//GEN-LAST:event_compileAllJavaMenuItemActionPerformed
    
    private void compileAllJSPMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compileAllJSPMenuItemActionPerformed
        // Add your handling code here:
        saveAllFiles sf = new saveAllFiles( this, true );
        sf.show();
        compileAllJSPFiles cajspf = new compileAllJSPFiles( this, false );
        cajspf.show();
        
    }//GEN-LAST:event_compileAllJSPMenuItemActionPerformed
    
    private void tagHandlerMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tagHandlerMenuItemActionPerformed
        // Add your handling code here:
        String projectBase = getBuildDirectory();
        
        newJSPTagHandler njth = new newJSPTagHandler( this, true, projectBase );
        njth.show();
    }//GEN-LAST:event_tagHandlerMenuItemActionPerformed
    
    private void classMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_classMenuItemActionPerformed
        // Add your handling code here:
        String projectBase = getBuildDirectory();
        
        newJavaClass njc = new newJavaClass( this, true, projectBase );
        njc.show();
    ...
    private void xmlMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xmlMenuItemActionPerformed
        ...
        newXML nx = new newXML( this, true, projectBase );
        nx.show();
    }//GEN-LAST:event_xmlMenuItemActionPerformed
    
    private void ExternalWebBrowserMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExternalWebBrowserMenuItemActionPerformed
        // Add your handling code here:
        externalBrowserHome browserhome = new externalBrowserHome( this, true );
        browserhome.show();
    }//GEN-LAST:event_ExternalWebBrowserMenuItemActionPerformed
    
    private void propertiesTabbedPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_propertiesTabbedPaneMouseClicked
        // Add your handling code here:
        int index = propertiesTabbedPane.getSelectedIndex();
        if( index == 1 ) {  // lib refresh
            updateDisplayJarLibTree();
        } else if( index == 2 ) {  // lib refresh
            updateDisplayJarClassPathTree();
        }
        
    }//GEN-LAST:event_propertiesTabbedPaneMouseClicked
    
    private void libScrollPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_libScrollPaneMouseClicked
        // Add your handling code here:
        //updateDisplayJarLibTree();
    }//GEN-LAST:event_libScrollPaneMouseClicked
    ...
    private void htmlTemplateProjectMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_htmlTemplateProjectMenuItemActionPerformed
        // Add your handling code here:
        newHtmlTemplate htmlt = new newHtmlTemplate( this, false );
        htmlt.show();
    ...
    private void compileProjectMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compileProjectMenuItemActionPerformed
        ...
        saveAllFiles sf = new saveAllFiles( this, true );
        sf.show();
        compileProjectFiles cpf = new compileProjectFiles( this, false );
        cpf.show();
    ...
    private void appMgrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_appMgrActionPerformed
        // Add your handling code here:
        tomcatManager tm = new tomcatManager( this, true );
        tm.show();
    }//GEN-LAST:event_appMgrActionPerformed
    ...
    private javax.swing.JMenuItem ExternalWebBrowserMenuItem;
    ...
    private javax.swing.JMenuItem compileAllJSPMenuItem;
    private javax.swing.JMenuItem compileAllJWSMenuItem;
    private javax.swing.JMenuItem compileAllJavaMenuItem;
    ...
    private javax.swing.JMenuItem tagHandlerMenuItem;
    ...
    private String compilejspbatchAll = "";
    private String mountedJar; //getBuildDirectory() + '\\' + "otherjar.properties";
    
    private DynamicTree treePanel = new DynamicTree( this );
    private ObjectTree objectTree = new ObjectTree( this );
    private LibTree libTree = new LibTree( this );
    private ClassPathTree classPathTree = new ClassPathTree( this );
    ...
    public String[] getMountedJarProperties() {
    ...
    public void openAntBuildXml() {
        ...
        mvcAntBuilderIF mvc = new mvcAntBuilderIF( this, selectedFile );
    ...
    public void compileAllFiles() {
        ...
        refreshWEBINF(); // refresh WEB-INF directory for JSP compilation
    ...
    public void compileProjectFiles() {
        ...
        compileAllJSP();
        compileAllJWS();
        printMessage( "Done compiling all project files" );
        
    }
    
    
    
    public void compileAllJAVA() {
        
        DirectoryScanner ds = new DirectoryScanner();
        String[] includes = { "**\\*.java" };
        String[] excludes = { "workarea\\**", "WEB-INF\\**" };
        ...
        printMessage( "Done compiling all Java files" );
        
    }
    
    
    public void compileAllJWS() {
        ...
        for( int i = 0 ; i < files.length ; i++ ) {
            ...
            if( targetFile.toLowerCase().endsWith( ".jws" ) ) {
        ...
        printMessage( "Done compiling all Java web service files" );
        
    }
    
    
    
    public void compileWorkAreaJavaFiles() {
        
        DirectoryScanner ds = new DirectoryScanner();
        String[] includes = { "workarea\\java\\**\\*.java" };
        ...
        refreshWEBINF(); // refresh WEB-INF for JSP compilation
    ...
    public boolean compileAllJSP() {
        ...
        // create ant JSP compiler script
        copyJspcAllXml();
        
        // create batch file
        createCompileJspAllBatchFile();
        ...
        // compile generated java files in workarea/java
        compileWorkAreaJavaFiles();
        
        printMessage( "Done compiling all JavaServer Pages files" );
        return rvalue;
    }
    ...
    public void editSourceCode( String selectedFile ) {
        ...
        if( new File( selectedFile ).isFile() ) {
            ...
            selectedFile.toUpperCase().endsWith( ".LST" ) ||
            selectedFile.toUpperCase().endsWith( ".BAT" ) ||
            selectedFile.toUpperCase().endsWith( ".TLD" ) ||
            selectedFile.toUpperCase().endsWith( ".SH" ) ||
            selectedFile.toUpperCase().endsWith( ".KSH" ) ||
            selectedFile.toUpperCase().endsWith( ".CMD" ) ||
            selectedFile.toUpperCase().endsWith( ".WSDD" ) ||
            selectedFile.toUpperCase().endsWith( ".TAG" ) ||
            selectedFile.toUpperCase().endsWith( ".WSDL" ) ) {
                if( !isFrameOpen( selectedFile ) ) {
                    editOtherSourceCode( selectedFile );
                }
            } else {
                if( selectedFile.toUpperCase().endsWith( ".CLASS" ) ||
                selectedFile.toUpperCase().endsWith( ".JAR" ) ||
                selectedFile.toUpperCase().endsWith( ".WAR" ) ||
                selectedFile.toUpperCase().endsWith( ".ZIP" ) ||
                selectedFile.toUpperCase().endsWith( ".EAR" )) {
                    // do not open this file type
                } else {
                    if( !isFrameOpen( selectedFile ) ) {
                        editOtherSourceCode( selectedFile );
                    }
    ...
    public void saveAllButtonAction() {
        ...
        for( int i = 0 ; i < jif.length ; i++ ) {
            ...
            if( className.endsWith( "mvcControllerIF" ) ) {
                String file = ( (mvcControllerIF ) jif[i] ).getFileSource();
                String code = ( (mvcControllerIF ) jif[i] ).getText();
                ...
                String file = ( (mvcWappDescriptorIF ) jif[i] ).getFileSource();
                String code = ( (mvcWappDescriptorIF ) jif[i] ).getText();
                if( !saveCodeToFile( code, file ) ) {
                    printMessage( "Error saving file to " + file );
                } else {
                    printMessage( "Done saving file to " + file );
                ...
                String file = ( (mvcAntBuilderIF ) jif[i] ).getFileSource();
                String code = ( (mvcAntBuilderIF ) jif[i] ).getText();
                if( !saveCodeToFile( code, file ) ) {
                    printMessage( "Error saving file to " + file );
                } else {
                    printMessage( "Done saving file to " + file );
        ...
        if( warFileName != null ) {
            ...
            printMessage( "Error: Can not find \"warfile\" or \"destfile\" in Ant build.xml" );
        }
    ...
    public void saveButtonAction() {
        ...
        if( className.endsWith( "mvcControllerIF" ) ) {
            String file = ( (mvcControllerIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            String code = ( (mvcControllerIF ) codeDesktopPane.getSelectedFrame() ).getText();
            if( !saveCodeToFile( code, file ) ) {
                printMessage( "Error saving file to " + file );
            } else {
                printMessage( "Done saving file to " + file );
            ...
            String file = ( (mvcWappDescriptorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            String code = ( (mvcWappDescriptorIF ) codeDesktopPane.getSelectedFrame() ).getText();
            if( !saveCodeToFile( code, file ) ) {
                printMessage( "Error saving file to " + file );
            } else {
                printMessage( "Done saving file to " + file );
            ...
            String file = ( (mvcAntBuilderIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            String code = ( (mvcAntBuilderIF ) codeDesktopPane.getSelectedFrame() ).getText();
            if( !saveCodeToFile( code, file ) ) {
                printMessage( "Error saving file to " + file );
            } else {
                printMessage( "Done saving file to " + file );
            ...
            printMessage( "Not in options to save Server Resource Factory" );
            /*
            if( !saveCodeToFile( code, file ) ) {
    ...
    public void openWebXml() {
        ...
        String selectedFile = getBuildDirectory() + "\\metadata\\web.xml";
        mvcWappDescriptorIF mvc = new mvcWappDescriptorIF( this, selectedFile );
        mvc.setLocation( windowXPos += 10, windowYPos += 10 );
        if( windowXPos > 40 ) {
            windowXPos = 0;
            windowYPos = 0;
    ...
    public void openControllerActionMap() {
        ...
        mvcControllerIF mvc = new mvcControllerIF( this, selectedFile );
        mvc.setLocation( windowXPos += 10, windowYPos += 10 );
        if( windowXPos > 40 ) {
            windowXPos = 0;
            windowYPos = 0;
    ...
    public void printMessage( String msg ) {
        ...
        if( message.length() > 0 ) {
            ...
            if( message.indexOf( ">pscp" ) != -1 ) {
                int start = message.indexOf( "pw " ) + 3;
            ...
            } else if( message.indexOf( "file(s) copied." ) != -1 ) {
                // do not print
            } else {
                buildmessage.append( message + "\n" );
                buildmessage.setCaretPosition( buildmessage.getText().length() );
    ...
    protected void removeFiles(File d, String[] files) {
        ...
        String backupDir = getBuildDirectory() + "\\backup";
        ...
        if( !backupDirectory.exists() ) {
            if( !backupDirectory.mkdir() ) {
                canBackup = false;
                printMessage( "Error creating backup directory" );
            }
        }
        ...
        if (files.length > 0) {
            ...
            for ( int i = 0 ; i < files.length ; i++ ) {
                ...
                String backupFileName = backupDir + '\\' + new Date().toString().replace( ' ', '_').replace( ':', '_' ) + '.' + f.getName();
                File back = new File( backupFileName );
                //printMessage( back.toString() );
                
                if ( !f.renameTo( back ) ) {
                    if( canBackup ) {
                        printMessage( "Error backing up " + f.getName() );
                    }
                }
    ...
    public void enableButtons( boolean b ) {
        ...
        propertiesTabbedPane.setEnabled( b );
        fileTable.setEnabled( b );
        ExternalWebBrowserMenuItem.setEnabled( b );
    }
    
    public void disableIDE() {
            ...
            if( client.readSetting() ) {
                ...
                if ( warFile.exists() ) {
                    ...
                    try {
                        ...
                        String commandLine = "pscp -P " + serverPort + " -pw " + pass + " -" + SSHVersion + " \"" + warPath + warFileName + "\" " + userID + '@' + SSHServer + ':' + remotedir;
        ...
        if( selectedFile.length() != 0 ) {
            ...
            if( codeFile.isFile() ) {
                ...
                if( relativePath.toUpperCase().startsWith( "/SRC" ) ) {
                    ...
                    remotedir = remoteDirectory + '/' + archiveName + relativePath;
                } else if( relativePath.toUpperCase().startsWith( "/METADATA" ) ) {
                    relativePath = "/META-INF" + relativePath.substring( 0, relativePath.lastIndexOf( '/' ) );
                    remotedir = remoteDirectory + '/' + archiveName + relativePath;
                    ...
                    relativePath = "/WEB-INF" + relativePath.substring( 0, relativePath.lastIndexOf( '/' ) );
                    remotedir = remoteDirectory + '/' + archiveName + relativePath;
                } else if( relativePath.toUpperCase().startsWith( "/TLD" ) ) {
                    relativePath = "/WEB-INF" + relativePath.substring( "/TLD".length(), relativePath.lastIndexOf( '/' ) );
                    remotedir = remoteDirectory + '/' + archiveName + relativePath;
                }
                ...
                if( client.exists() ) {
                    ...
                    if( client.readSetting() ) {
                        ...
                        if ( codeFile.exists() ) {
                            ...
                            printMessage( "Sending " + codeFile.toString() + " to " + SSHServer + ":" + remotedir);
                            ...
                            try {
                                ...
                                String commandLine = "pscp -P " + serverPort + " -pw " + SSHPassword + " -" + SSHVersion + " \"" + selectedFile + "\" " + userID + '@' + SSHServer + ':' + remotedir;
    ...
    public boolean deleteFile( String fileName) {
        ...
        { getBuildDirectory()+ "\\metadata",
          ...
          getBuildDirectory()+ "\\tld",
          getBuildDirectory()+ "\\Templates",
          getBuildDirectory()+ "\\workarea",
          getBuildDirectory()+ "\\backup"
        };
    ...
    public boolean deleteDirectory( String selectedFile ) {
        ...
        String beginsWith = getBuildDirectory() + "\\workarea\\";
        String backUpDir = beginsWith + date;
        
        if( selectedFile.startsWith( beginsWith ) ) {
            osDeleteDir( selectedFile );
        } else if( new File( selectedFile ).renameTo( new File( backUpDir ) ) ) {
    ...
    public String createTagHandlerTemplate( String template, String targetFile ) {
        ...
        beanTemplate = getArchiverBaseDir() + "templates\\java\\tag\\" + template;
    ...
    public String createClassTemplate( String template, String targetFile ) {
        ...
        beanTemplate = getArchiverBaseDir() + "templates\\java\\class\\" + template;
    ...
    public String createXMLTemplate( String template, String targetFile ) {
        
        String rvalue = new String();
        String xmlTemplate = new String();
        
        xmlTemplate = getArchiverBaseDir() + "templates\\xml\\" + template;
        
        if( !new File( targetFile ).exists() ) {
            if( !saveCodeToFile( readTextTemplate( xmlTemplate ), targetFile ) ) {
                printMessage( "Error creating " + targetFile );
            } else {
                printMessage( "Created " + targetFile );
            }
    ...
    public void remoteCommand( String command ) {
        ...
        if( client.exists() ) {
            ...
            if( client.readSetting() ) {
                ...
                loaderPassword = client.getLoaderPassword();
                SSHServer = client.getServerName();
                ...
                try {
                    ...
                    try {
                        ...
                        output.writeBytes( loaderPassword + " " + command + " " + warFileName + "\n\n" );
                        output.flush();
            ...
            if( client.readSetting() ) {
                ...
                try {
                    ...
                    try {
                        ...
                        output.writeBytes( loaderPassword + " " + command + " " + appName + "\n\n" );
                        output.flush();
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            //printMessage( command + " " + appName );
                            //output.write( command + " " + appName );
                            output.writeBytes( loaderPassword + " " + command + " " + appName + " " + jarName + "\n\n" );
                            output.flush();
    ...
    public void undoEdit() {
        ...
        if( className.endsWith( "mvcControllerIF" ) ) {
            ...
            mvcControllerIF frame = (mvcControllerIF) codeDesktopPane.getSelectedFrame();
            frame.undoEdit();
            
        } else if( className.endsWith( "mvcWappDescriptorIF" ) ) {
            
            mvcWappDescriptorIF frame = (mvcWappDescriptorIF) codeDesktopPane.getSelectedFrame();
            frame.undoEdit();
            ...
            mvcAntBuilderIF frame = (mvcAntBuilderIF) codeDesktopPane.getSelectedFrame();
            frame.undoEdit();
    ...
    public boolean isBrowserViewable() {
        ...
        if( className.endsWith( "sourceHTMLEditorIF" ) ) {
            rvalue = true;
        } else if( className.endsWith( "sourceHTMLTemplateEditorIF" ) ) {
            rvalue = true;
        } else if( className.endsWith( "sourceGraphicsViewerIF" ) ) {
            rvalue = true;
        }
    ...
    public void deleteItem() {
        ...
        if( selectedFile.length() > 0 ) {
            if( new File( selectedFile ).isFile() ) {
                ...
                selectedFile.startsWith( getBuildDirectory()+ "\\tld" ) ||
                selectedFile.startsWith( getBuildDirectory()+ "\\backup" ) ||
                selectedFile.startsWith( getBuildDirectory()+ "\\workarea" ) ||
                selectedFile.startsWith( getBuildDirectory()+ "\\Templates" ) ) {
                ...
                selectedFile.equalsIgnoreCase( getBuildDirectory()+ "\\tld" ) ||
                selectedFile.equalsIgnoreCase( getBuildDirectory()+ "\\workarea" ) ||
                selectedFile.equalsIgnoreCase( getBuildDirectory()+ "\\Templates" ) ||
                selectedFile.equalsIgnoreCase( getBuildDirectory()+ "\\backup" ) ) {
    ...
    public String readBuildXml( String fileSource, String warFileName ) {
        ...
        if( !new File( fileSource ).exists() ) {
            printMessage( "Error: " + fileSource + " does not exist.  Please reinstall DevCentre");
            return rvalue;
        }
    ...
    private boolean createCompileJspAllBatchFile() {
        
        String targetFile = getCompileJspAllBatch();
        String classpath = "set CLASSPATH=" + getClassPath().replace( '\"', ' ' ).trim();
        compilejspbatchAll = targetFile;
        // ----------------------------------
        String[] antJars = getAntJars();
        ...
        // -----------------------------
        //String antcommand = "ant -f \"" + getBuildDirectory() + "\\jspc.xml\"";
        String antcommand =  getJavaHomeDir() + "\\bin\\java -Dant.home=" + antHome + " org.apache.tools.ant.Main -f " + '\"' + projectPath + "\\jspcAll.xml\"";
    ...
    public String getCompileJspAllBatch() {
        
        compilejspbatch = getBuildDirectory() + '\\' + "compilejspall.bat";
        return compilejspbatch;
    }
    ...
    // update display file properties
    public void displayFileProperties( String filePath ) {
        
        selectedFile = filePath; // update selected file
        
        File file = new File( filePath );
        boolean existing = file.exists();
        
        fileTable.getModel().setValueAt( "Exists", 0, 0 );
        fileTable.getModel().setValueAt( existing? "True" : "False", 0, 1 );
        
        fileTable.getModel().setValueAt( "Type", 1, 0 );
        fileTable.getModel().setValueAt( existing? ( file.isDirectory()? "Directory" : "File" ) : "", 1, 1 );
        
        fileTable.getModel().setValueAt( "Readable", 2, 0 );
        fileTable.getModel().setValueAt( existing? ( file.canRead()? "True" : "False" ) : "", 2, 1 );
        
        fileTable.getModel().setValueAt( "Writable", 3, 0 );
        fileTable.getModel().setValueAt( existing? ( file.canWrite()? "True" : "False" ) : "", 3, 1 );
        
        fileTable.getModel().setValueAt( "Last Modified", 4, 0 );
        fileTable.getModel().setValueAt( existing? new Date( file.lastModified() ).toString() : "", 4, 1 );
        
        fileTable.getModel().setValueAt( "File Size", 5, 0 );
        fileTable.getModel().setValueAt( existing? new Long( file.length() ).toString() + " Bytes" : "" , 5, 1 );
        
        // enable / disable panels depending on file type
        // .class - enable Object panel
        // otherwise disable Object panel
        if( existing ) {
            if( filePath.endsWith( ".class" ) ) {
                objectTree.clear();
                objectTree.initTree( filePath );
                objectScrollPane.enable( true );
            } else {
                objectTree.clear();
                objectTree.initTree();
                objectScrollPane.enable( false );
            }
        }
        
    }
    
    // set selected file from tree
    ...
    // get jar libraries
    public void updateDisplayJarLibTree() {
        
        String libDir = getBuildDirectory() + "\\lib";
        String[]  exclude = {};
        String[]  include = { "*.jar" };
        String[] jars = listFiles( libDir, exclude, include  );
        
        libTree.refreshTree( libDir, jars );
    ...
    // get jar libraries
    public void updateDisplayJarClassPathTree() {
        
        mountedJar = getMountedJar();
        
        if( !new File( mountedJar ).exists() ) {
            createdMountedJarFile();
        } else {
            String[] jars = getMountedJarProperties();
            classPathTree.refreshTree( jars );
        }
    ...
    // read data
    public void storeBrowserHome() {
        
        String fileName = getArchiverBaseDir() + browserHome;
        String rvalue = new String();
        DataInputStream browserHomeConfig = null;
        File home = new File( fileName );
        
        if( home.exists() ) {
            try {
                browserHomeConfig = new DataInputStream( new BufferedInputStream( new FileInputStream( fileName ) ) );
                try {
                    rvalue = browserHomeConfig.readLine();
                    //DataInputStream in;
                } catch( IOException e ){
                }
            } catch( IOException e){
    ...
    public void viewInBrowser( String filePath ) {
        
        String browser = getBrowserExecutable();
        
        if( browser.length() == 0 ) {
            printMessage( "Please select your web browser executable" );
        } else {
            ...
            try {
                String[] cmd = new String[3];
                String commandLine = browser + " " + filePath;
                String browserBatch = "browser.bat";
                
                cmd[0] = "cmd.exe" ;
                cmd[1] = "/C" ;
                cmd[2] = getBuildDirectory() + '\\' + "browseFile.bat";;
                
                createBrowserBatchFile( cmd[2], commandLine );
    ...
    private boolean createBrowserBatchFile( String targetFile, String commandLine ) {
    ...
    public String getSelectedFileFromIF() {
        ...
        if( jif.length > 0 ) {
            ...
            if( className.endsWith( "mvcControllerIF" ) ) {
                selectedFile = ( (mvcControllerIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "mvcWappDescriptorIF" ) ) {
                selectedFile = ( (mvcWappDescriptorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "mvcControllerSettingIF" ) ) {
                selectedFile = ( (mvcControllerSettingIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "mvcDBConnectionPoolIF" ) ) {
                selectedFile = ( (mvcDBConnectionPoolIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceJSPEditorIF" ) ) {
                selectedFile = ( (sourceJSPEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceJAVAEditorIF" ) ) {
                selectedFile = ( (sourceJAVAEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceJWSEditorIF" ) ) {
                selectedFile = ( (sourceJWSEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceHTMLEditorIF" ) ) {
                selectedFile = ( (sourceHTMLEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceHTMLTemplateEditorIF" ) ) {
                selectedFile = ( (sourceHTMLTemplateEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceOtherEditorIF" ) ) {
                selectedFile = ( (sourceOtherEditorIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "mvcAntBuilderIF" ) ) {
                selectedFile = ( (mvcAntBuilderIF ) codeDesktopPane.getSelectedFrame() ).getFileSource();
            } else if( className.endsWith( "sourceServerResourceFactoryIF" ) ) {
                // do nothing
            } else {
                // do nothing
    ...
    public void refreshWEBINF() {
        
        String webinfDir = getBuildDirectory() + "\\WEB-INF";
        String tldDir = getBuildDirectory() + "\\tld";
        File webinf = new File( webinfDir );
        String fileName;
        File item;
        ...
        String[] dirs = listDirs( webinfDir );
        for( int i = 0 ; i < dirs.length ; i++ ) {
            fileName = webinfDir + "\\" + dirs[i];
            if( !fileName.equals( webinfDir + '\\' ) ) {
                osDeleteDir( '\"' + fileName + '\"' );
            }
        }
        
        // remove old files
        String[] files = listFiles( webinfDir );
        for( int i = 0 ; i < files.length ; i++ ) {
            fileName = webinfDir + "\\" + files[i];
            osDeleteFile( '\"' + fileName + '\"' );
        }
        
        // -------------------------------------
        // create directories
        dirs = listDirs( tldDir );
        for( int i = 0 ; i < dirs.length ; i++ ) {
            fileName = webinfDir + "\\" + dirs[i];
        ...
        // copy files
        files = listFiles( tldDir );
        String targetFileName;
        for( int i = 0 ; i < files.length ; i++ ) {
            fileName = tldDir + "\\" + files[i];
            targetFileName = webinfDir + "\\" + files[i];
            copyFile( '\"' + fileName + '\"', '\"' + targetFileName + '\"' );
        }
        
        // copy web.xml
        String webxmlFileName = getBuildDirectory() + "\\metadata\\web.xml";
        targetFileName = webinfDir + "\\web.xml";
        copyFile( '\"' + webxmlFileName + '\"', '\"' + targetFileName + '\"' );
        
        printMessage( "Refreshed files in local \\WEB-INF");
        
    }
    
    
    
    public void copyJspcAllXml() {
        
        String rvalue = new String();
        
        String jspcTemplate = getArchiverBaseDir() + "templates\\jspcAll.xml";
        String projDir = getBuildDirectory();
        
        copyFile( "\"" + jspcTemplate + "\""  ,  "\"" + projDir + "\"" );
        
    }
    
    
    private void refreshJSPWorkArea() {
        
        String jspJava = getBuildDirectory() + "\\workarea\\java";
        
        if( new File( jspJava ).exists() ) {
            printMessage( "Refreshed " + jspJava );
            osDeleteDir( "\"" + jspJava + "\"");
        }
