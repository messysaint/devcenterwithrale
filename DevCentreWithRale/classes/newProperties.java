 ...
 * @author  test1
 */
public class newProperties extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newProperties(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newPropertiesTextField = new javax.swing.JTextField();
        ...
        newPropertiesTextField.setFont(new java.awt.Font("Default", 0, 11));
        newPropertiesTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newPropertiesTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        jPanel6.add(newPropertiesTextField);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        String newProperties = newPropertiesTextField.getText().trim();        
        String propertiesTemplate = new String( "generic" );
        
        if( newProperties.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {            
            newProperties = getTreeCurrentPath() + '\\' + newProperties + ".properties";                 
            main.createPropertiesTemplate( propertiesTemplate, newProperties );   
            if( new File( newProperties  ).exists() ) {
                main.editSourceCode( newProperties );
            }
        }
    ...
    private javax.swing.JTextField newPropertiesTextField;
    ...
    private PropertiesTree treePanel = new PropertiesTree();    
