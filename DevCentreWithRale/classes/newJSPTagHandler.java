 ...
 * @author  test1
 */
public class newJSPTagHandler extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newJSPTagHandler(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newJSPTagHandlerTextField = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jLabel111 = new javax.swing.JLabel();
        JSPTagHandlerTemplateComboBox = new javax.swing.JComboBox();
        ...
        newJSPTagHandlerTextField.setFont(new java.awt.Font("Default", 0, 11));
        newJSPTagHandlerTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newJSPTagHandlerTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        jPanel6.add(newJSPTagHandlerTextField, gridBagConstraints);
        ...
        JSPTagHandlerTemplateComboBox.setFont(new java.awt.Font("Default", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(JSPTagHandlerTemplateComboBox, gridBagConstraints);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        String newJSPTagHandler = newJSPTagHandlerTextField.getText().trim();        
        String JSPTagHandlerTemplate = (String) JSPTagHandlerTemplateComboBox.getSelectedItem();
        
        if( newJSPTagHandler.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {
                     
            newJSPTagHandler = getTreeCurrentPath() + '\\' + newJSPTagHandler + ".java";                 
            main.createTagHandlerTemplate( JSPTagHandlerTemplate, newJSPTagHandler );     
            if( new File( newJSPTagHandler  ).exists() ) {
                main.editSourceCode( newJSPTagHandler );
            }
        }
    ...
    private javax.swing.JComboBox JSPTagHandlerTemplateComboBox;
    ...
    private javax.swing.JTextField newJSPTagHandlerTextField;
    ...
    private String mountDir = "classes";
    ...
    public void setTemplates() {
        ...
        String[] temp = main.listFiles( main.getArchiverBaseDir() + "\\templates\\java\\tag", new String[] {}, new String[] { "*.tpt" } );         
        JSPTagHandlerTemplateComboBox.setModel(new javax.swing.DefaultComboBoxModel( temp ) );
    }
}
