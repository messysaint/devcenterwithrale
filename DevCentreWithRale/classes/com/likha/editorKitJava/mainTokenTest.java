 ...
 */
public class mainTokenTest implements Serializable {

    mainTokenTest(String representation, int scanValue) {
    ...
    public static void main( String[]  args ) {
        ...
        // all operator 
        System.out.println( "Operators [ 0 - 58 ]:\n" );
        for( int i = 0 ; i < operators.length ; i++ ) {
            System.out.println( operators[i].toString() + "    " + operators[i].getScanValue() );            
        }
        
        // all values values 
        System.out.println( "Values [ 60 - 69 ]:\n" );
        for( int i = 0 ; i < values.length ; i++ ) {
            System.out.println( values[i].toString() + "    " + values[i].getScanValue() );            
        }
        
        // all types 
        System.out.println( "Types [ 70 - 78 ]:\n" );
        for( int i = 0 ; i < types.length ; i++ ) {
            System.out.println( types[i].toString() + "    " + types[i].getScanValue() );            
        }
        
        // all expressions
        System.out.println( "Expressions [ 80 - 84 ]:\n" );
        for( int i = 0 ; i < expressions.length ; i++ ) {
            System.out.println( expressions[i].toString() + "    " + expressions[i].getScanValue() );            
        }
        
        // all statements
        System.out.println( "Statements [ 90 - 108 ]:\n" );
        for( int i = 0 ; i < statements.length ; i++ ) {
            System.out.println( statements[i].toString() + "    " + statements[i].getScanValue() );            
        }
        
        // all declarations
        System.out.println( "Declarations [ 110 - 115 ]:\n" );
        for( int i = 0 ; i < declarations.length ; i++ ) {
            System.out.println( declarations[i].toString() + "    " + declarations[i].getScanValue() );            
        }
        
        
        // all modifiers
        System.out.println( "Modifiers [ 120 - 130 ]:\n" );
        for( int i = 0 ; i < modifiers.length ; i++ ) {
            System.out.println( modifiers[i].toString() + "    " + modifiers[i].getScanValue() );            
        }
        
        // all punctuations
        System.out.println( "Punctuations [ 135 - 144 ]:\n" );
        for( int i = 0 ; i < punctuations.length ; i++ ) {
            System.out.println( punctuations[i].toString() + "    " + punctuations[i].getScanValue() );            
        }
    
        // all specials
        System.out.println( "Specials [ 145 - 152 ]:\n" );
        for( int i = 0 ; i < specials.length ; i++ ) {
            System.out.println( specials[i].toString() + "    " + specials[i].getScanValue() );            
        }
