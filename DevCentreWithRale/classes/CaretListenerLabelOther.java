...
//This listens for and reports caret movements.
public class CaretListenerLabelOther extends JLabel implements CaretListener {
    ...
    int lnum = 0;
    int textPos = 0;
    CodeEditorPaneOther codeTextArea;
    
    public CaretListenerLabelOther(String label, CodeEditorPaneOther editPane) {        
        super(label);
