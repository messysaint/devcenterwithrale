 ...
 * @author  test1
 */
public class mvcWappDescriptorIF extends javax.swing.JInternalFrame {
    
    
    /** Creates new form mvcController */
    public mvcWappDescriptorIF(mainForm mainSource, String selectedFile) {
        ...
        if( !new File( fileSource ).exists() ) {
            ...
            main.copyFile( '\"' + main.getArchiverBaseDir() + "templates\\web.xml\"", "\"" + fileSource + "\"" );            
        }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Deployment Descriptor");
