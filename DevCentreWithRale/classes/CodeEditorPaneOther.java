 ...
 * @author  test1
 */
public class CodeEditorPaneOther extends JEditorPane implements MouseListener, KeyListener, Runnable {
    ...
    public CodeEditorPaneOther(mainForm main) {
        ...
        // @ sign
        //s = styles.getStyleForScanValue(Token.AT.getScanValue());
        //StyleConstants.setForeground(s, new Color(216,48,5 ));
