 ...
 * @author  test1
 */
public class remoteGetServerXml extends javax.swing.JDialog implements Runnable {
    
    String command = new String();
    
    /** Creates new form projectOpen */
    public remoteGetServerXml(mainForm parent, boolean modal, String cmd) {
        super(parent, modal);
        initComponents();
        myParent = parent;
        command = cmd;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Get Server Resource Factory");
    ...
    public void run() {
        ...
        try {
            if( command.equalsIgnoreCase( "getServerResourceFactory") ) {
                messageLabel.setText( "Retrieving Server Resource Factory, please wait ..." );
            }                                     
            
            String serverXmlPath = myParent.remoteOtherCommand( "getServerResourceFactoryPath", "dummy" ); 
            myParent.setRemoteServerXmlPath( serverXmlPath );            
            String message = myParent.remoteOtherCommand( command, "dummy" ); 
            message = message.replace( '|', '\n' );
            //sourceServerResourceFactoryIF.codeTextArea.setText( message );
            sourceServerResourceFactoryIF.setCodeTextArea( message );
