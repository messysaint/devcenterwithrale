 ...
 * @author  test1
 */
public class getWebAppDir extends javax.swing.JDialog implements Runnable {        
    
    /** Creates new form projectOpen */
    public getWebAppDir(mainForm parent, JDialog toDialog, boolean modal, String cmd, String warFile, String server, int port, String user, String password ) {
