 ...
 * @author  test1
 */
public class saveAllFiles extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public saveAllFiles(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Saving all open files");
        ...
        jLabel1.setText("Please wait while saving all open file...");
    ...
    public static void main(String args[]) {
        new saveFile( new mainForm(), true ).show();
    }
