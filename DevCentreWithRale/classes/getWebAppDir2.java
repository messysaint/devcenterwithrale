 ...
 * @author  test1
 */
public class getWebAppDir2 extends javax.swing.JDialog implements Runnable {        
    
    /** Creates new form projectOpen */
    public getWebAppDir2(mainForm parent, JDialog toDialog, boolean modal, String cmd, String warFile, String server, int port, String user, String password) {
    ...
    public void run() {
        ...
        try {
            if( command.equalsIgnoreCase( "getwebapplicationdir") ) {
                messageLabel.setText( "Getting web application directory, please wait ..." );
            }
            
            //remoteOtherCommand( String serverName, int portNum, String userName, String userPassword, String command, String webAppName ) 
            String httpMessage = myParent.remoteOtherCommand( serverName, portNum, userName, userPassword,command, appName );
            httpMessage = httpMessage.replace( nextLine, '\n' );
            //myParent.printMessage( httpMessage );
            //projectNew.sshRemoteDirectory.setText( httpMessage );
            projectConnectionSettings.sshRemoteDirectory.setText( httpMessage );
