 ...
 * @author  test1
 */
public class newJavaBean extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newJavaBean(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newBeanTextField = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jLabel111 = new javax.swing.JLabel();
        javaBeanTemplateComboBox = new javax.swing.JComboBox();
        ...
        newBeanTextField.setFont(new java.awt.Font("Default", 0, 11));
        newBeanTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newBeanTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        jPanel6.add(newBeanTextField, gridBagConstraints);
        ...
        javaBeanTemplateComboBox.setFont(new java.awt.Font("Default", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(javaBeanTemplateComboBox, gridBagConstraints);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        String newBean = newBeanTextField.getText().trim();        
        String beanTemplate = (String) javaBeanTemplateComboBox.getSelectedItem();
        
        if( newBean.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {
                     
            newBean = getTreeCurrentPath() + '\\' + newBean + ".java";                 
            main.createBeanTemplate( beanTemplate, newBean );    
            if( new File( newBean  ).exists() ) {
                main.editSourceCode( newBean );
            }
        }
    ...
    private javax.swing.JComboBox javaBeanTemplateComboBox;
    ...
    private javax.swing.JTextField newBeanTextField;
    ...
    public void setTemplates() {
        ...
        String[] temp = main.listFiles( main.getArchiverBaseDir() + "\\templates\\java\\bean", new String[] {}, new String[] { "*.tpt" } );         
        javaBeanTemplateComboBox.setModel(new javax.swing.DefaultComboBoxModel( temp ) );
    }
}
