 ...
 * @author  test1
 */
public class mountJarLibrary extends javax.swing.JDialog {
    
    /** Creates new form projectOpen */
    public mountJarLibrary(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
        
        mountedJar = myParent.getMountedJar();
        
        if( !new File( mountedJar ).exists() ) {            
            myParent.createdMountedJarFile();
        }
        
        jarListTextArea.setText( myParent.readMountedJarProperties() );
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jarListTextArea = new javax.swing.JTextArea();
        ...
        addButton.setFont(new java.awt.Font("Default", 0, 11));
        ...
        removeButton.setFont(new java.awt.Font("Default", 0, 11));
        ...
        jLabel1.setText("Java Archive List");
        ...
        jarListTextArea.setEditable(false);
        jarListTextArea.setFont(new java.awt.Font("Default", 0, 11));
        jScrollPane1.setViewportView(jarListTextArea);
        ...
        setSize(new java.awt.Dimension(451, 350));
        setLocation((screenSize.width-451)/2,(screenSize.height-350)/2);
    }//GEN-END:initComponents
    
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        // Add your handling code here:
        String jarList = jarListTextArea.getText();
        StringTokenizer tokenizer = new StringTokenizer( jarList, "\n", false );
        String[] comments = new String[ tokenizer.countTokens() ];
        int i = 0;
        
        while( tokenizer.hasMoreTokens() ) {
            comments[ i++ ] = tokenizer.nextToken();
        }
        
        myParent.createConfigFile( mountedJar, comments );   
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if( jarFile.length() > 0 ) {
            while( tokenizer.hasMoreTokens() ) {
                ...
                if( !token.toLowerCase().endsWith( jarFile.toLowerCase() ) ) {
                    if( ctr == 1 ) {
                        newList += token;
                    } else {
                        newList += '\n' + token;
            ...
            jarListTextArea.setText( newList );
        }
            ...
            if( fromJar.exists() ) {
                if( fromJar.isFile() ) {
                    if( jarFile.toLowerCase().endsWith( ".jar" ) ) {
                        if( jarListTextArea.getText().indexOf( jarFile ) == -1 ) {
                            jarListTextArea.append( '\n' + jarFile );
                        }
                    }
                }
            }
    ...
    private javax.swing.JTextArea jarListTextArea;
