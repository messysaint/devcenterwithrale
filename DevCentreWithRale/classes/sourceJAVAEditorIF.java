 ...
 * @author  test1
 */
public class sourceJAVAEditorIF extends javax.swing.JInternalFrame {
    
    
    /** Creates new form mvcController */
    public sourceJAVAEditorIF(mainForm mainSource, String selectedFile) {
        ...
        initCodeTextArea();
        codeTextArea.setText( readFile().trim() );    // color coded
    ...
    // CodeTextArea codeTextArea;  // plain balck and white
    private CodeEditorPaneJava codeTextArea;  // color coded
