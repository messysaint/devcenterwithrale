 ...
 * @author  test1
 */
public class newText extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newText(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newTextTextField = new javax.swing.JTextField();
        ...
        newTextTextField.setFont(new java.awt.Font("Default", 0, 11));
        newTextTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newTextTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        jPanel6.add(newTextTextField);
        ...
        setBounds((screenSize.width-480)/2, (screenSize.height-270)/2, 480, 270);
    }//GEN-END:initComponents
    
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        // Add your handling code here:
        String newText = newTextTextField.getText().trim();        
        String textTemplate = new String( "generic" );
        
        if( newText.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {            
            newText = getTreeCurrentPath() + '\\' + newText + ".txt";                 
            main.createTextTemplate( textTemplate, newText );   
            if( new File( newText  ).exists() ) {
                main.editSourceCode( newText );
            }
        }
    ...
    private javax.swing.JTextField newTextTextField;
