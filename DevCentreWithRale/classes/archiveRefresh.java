 ...
 * @author  test1
 */
public class archiveRefresh extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public archiveRefresh(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Generating web archive");
        ...
        jLabel1.setText("Please wait while generating web archive ...");
