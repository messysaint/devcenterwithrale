 ...
 * @author  test1
 */
public class newJavaClass extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newJavaClass(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newClassTextField = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jLabel111 = new javax.swing.JLabel();
        javaClassTemplateComboBox = new javax.swing.JComboBox();
        ...
        newClassTextField.setFont(new java.awt.Font("Default", 0, 11));
        newClassTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newClassTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        jPanel6.add(newClassTextField, gridBagConstraints);
        ...
        javaClassTemplateComboBox.setFont(new java.awt.Font("Default", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(javaClassTemplateComboBox, gridBagConstraints);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        String newClass = newClassTextField.getText().trim();        
        String classTemplate = (String) javaClassTemplateComboBox.getSelectedItem();
        
        if( newClass.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {
                     
            newClass = getTreeCurrentPath() + '\\' + newClass + ".java";                 
            main.createClassTemplate( classTemplate, newClass );     
            if( new File( newClass  ).exists() ) {
                main.editSourceCode( newClass );
            }
        }
    ...
    private javax.swing.JComboBox javaClassTemplateComboBox;
    private javax.swing.JTextField newClassTextField;
    ...
    public void setTemplates() {
        ...
        String[] temp = main.listFiles( main.getArchiverBaseDir() + "\\templates\\java\\class", new String[] {}, new String[] { "*.tpt" } );         
        javaClassTemplateComboBox.setModel(new javax.swing.DefaultComboBoxModel( temp ) );
    }
}
