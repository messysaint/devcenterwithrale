 ...
 * @author  test1
 */
public class compileAllJAVAFiles extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public compileAllJAVAFiles(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    public static void main(String args[]) {
        //new compileAllJAVAFiles( new mainForm(), true ).show();
    }
