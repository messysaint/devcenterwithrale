 ...
 * @author  test1
 */
public class newJavaServlet extends javax.swing.JDialog {
    
    /** Creates new form saveYesNo */
    public newJavaServlet(mainForm parent, boolean modal, String treeRoot) {
        super(parent, modal);
        initComponents();
        main = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        newServletTextField = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jLabel111 = new javax.swing.JLabel();
        javaServletTemplateComboBox = new javax.swing.JComboBox();
        ...
        newServletTextField.setFont(new java.awt.Font("Default", 0, 11));
        newServletTextField.setMinimumSize(new java.awt.Dimension(200, 19));
        newServletTextField.setPreferredSize(new java.awt.Dimension(200, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        jPanel6.add(newServletTextField, gridBagConstraints);
        ...
        javaServletTemplateComboBox.setFont(new java.awt.Font("Default", 0, 11));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel6.add(javaServletTemplateComboBox, gridBagConstraints);
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        String newServlet = newServletTextField.getText().trim();        
        String servletTemplate = (String) javaServletTemplateComboBox.getSelectedItem();
        
        if( newServlet.length() == 0 || getTreeCurrentPath().length() == 0 ) {
            return;
        } else {
                     
            newServlet = getTreeCurrentPath() + '\\' + newServlet + ".java";                 
            main.createServletTemplate( servletTemplate, newServlet );    
            if( new File( newServlet  ).exists() ) {
                main.editSourceCode( newServlet );
            }
        }
    ...
    private javax.swing.JTextField newServletTextField;
    private javax.swing.ButtonGroup selectionGroup;
    private javax.swing.JButton createButton;
    private javax.swing.JLabel jLabel111;
    private javax.swing.JLabel jLabel11;
    private javax.swing.JComboBox javaServletTemplateComboBox;
    ...
    private ServletTree treePanel = new ServletTree();    
    ...
    public void setTemplates() {
        ...
        String[] temp = main.listFiles( main.getArchiverBaseDir() + "\\templates\\java\\servlet", new String[] {}, new String[] { "*.tpt" } );         
        javaServletTemplateComboBox.setModel(new javax.swing.DefaultComboBoxModel( temp ) );
    }
}
