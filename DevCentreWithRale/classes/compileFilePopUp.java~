 ...
 * @author  test1
 */
public class compileFilePopUp extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public compileFilePopUp(mainForm parent, boolean modal, String src ) {
        super(parent, modal);
        initComponents();
        myParent = parent;
        srcFile = src;
    ...
    public static void main(String args[]) {
        new compileFile( new mainForm(), true ).show();
    }
    ...
    public void run() {
        ...
        try {                        
            myParent.compileFilePopUp( srcFile );            
