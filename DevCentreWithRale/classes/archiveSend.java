 ...
 * @author  test1
 */
public class archiveSend extends javax.swing.JDialog implements Runnable {
    
    /** Creates new form projectOpen */
    public archiveSend(mainForm parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myParent = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please wait while sending web archive to server...");
